...
function buildPrompt(dateYmd, headlines) {
    ...
    return [
        ...
        'Pick the SINGLE story dominating news and social media RIGHT NOW — the one scrolling every feed today.',
        '',
        'The bar: a player reads it and immediately thinks "oh shit, that is going on today."',
        'Name the headline topic plainly (Supreme Court, Trump, Congress, war, election, etc.). Use "today" when the story broke today.',
        '',
        'Good examples (instantly recognizable + fact-checkable):',
        '- Did the Supreme Court strike down President Trump\'s executive order ending birthright citizenship today, and what was the vote?',
        '- Did U.S. inflation peak above 9% year-over-year in 2022, and what did the CPI show when it began falling?',
        '',
        'Bad examples (too dry, buried in procedure, or not obviously today):',
        '- Vote counts in obscure agency firing cases without naming the live controversy.',
        '- "As the Court closed its term in late June..." (reads like homework, not a push alert).',
        '',
        'Rules:',
        '- One sentence, ends with ?, under 200 characters if possible.',
        '- Lead with the recognizable hook; tuck verifiable details (vote count, dollar figure, date) after it.',
        '- Answerable from reputable reporting. No "who is right" or vague "what do you think".',
        '- Neutral tone for two players fact-checking together.',
        '',
